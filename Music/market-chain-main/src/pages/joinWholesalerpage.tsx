...
import { Store, CheckCircle, Lock, Mail } from 'lucide-react';
import { 
...
import { createUserInDatabase, WholesalerData } from '../services/userService';

const JoinWholesalerPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const wholesalerData: Partial<WholesalerData> = {
      ...
      await createUserInDatabase(user, wholesalerData);
      setCurrentStep(4);
      navigate('/wholesaler-dashboard'); // Redirect after success
    } catch (err: any) {
  ...
  const handleNext = () => {
    if (currentStep === 1 && formData.fullName && formData.email && formData.contactNumber) {
      setCurrentStep(2);
    } else if (currentStep === 2) {
      if (formData.shopName && formData.shopLocation && formData.address && formData.pincode) {
        setCurrentStep(3);
      } else {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600">
            Complete your registration to start supplying to trusted retailers
          </p>
        </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#5DAE49] focus:border-transparent"
                    placeholder="Your wholesaler shop name"
                    required
                  />
                </div>
                <div>
          ...
          {currentStep === 4 && (
            ...
            >
              ...
              <p className="text-gray-600 mb-8">
                Your wholesaler account has been created successfully. You can now start supplying to verified retailers.
              </p>
              <button 
...
export default JoinWholesalerPage;