          ...
          <div className="hidden md:flex items-center space-x-3">
            {isAuthenticated && user ? (
              ...
              <>
                <Link
                  to="/login"
                  className="px-4 py-2 text-sm font-medium text-[#5DAE49] border border-[#5DAE49] rounded-lg hover:bg-[#5DAE49] hover:text-white transition-colors"
                >
                  Login
                </Link>
                <Link
                  to="/join-retailer"
                  className="px-4 py-2 text-sm font-medium text-white bg-[#5DAE49] rounded-lg hover:bg-green-600 transition-colors"
                >
                  Join Now
                </Link>
              </>
